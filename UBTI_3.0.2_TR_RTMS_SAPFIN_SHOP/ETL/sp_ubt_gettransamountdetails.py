...
def sp_ubt_gettransamountdetails(in_fromdatetime, in_todatetime, logger):
    ...
    df_getcommonubtdates = sp_ubt_getcommonubtdates(in_fromdatetime, in_todatetime, logger)
    if df_getcommonubtdates.empty:
        logger.warning(f"[SP_GETTRANSAMOUNTDETAILS] "
                    f"SP_UBT_GETCOMMONUBTDATES returned no records.")
    vfromdatetimebmcs = df_getcommonubtdates["fromdatetimebmcs"].iloc[0]
    vtodatetimebmcs = df_getcommonubtdates["todatetimebmcs"].iloc[0]
    vfromdatetimeigt = df_getcommonubtdates["fromdatetimeigt"].iloc[0]
    vtodatetimeigt = df_getcommonubtdates["todatetimeigt"].iloc[0]
    vfromdatetimeob = df_getcommonubtdates["fromdatetimeob"].iloc[0]
    vtodatetimeob = df_getcommonubtdates["todatetimeob"].iloc[0]
    vfromdatetimenh = df_getcommonubtdates["fromdatetimenonhost"].iloc[0]
    vtodatetimenh = df_getcommonubtdates["todatetimenonhost"].iloc[0]
    vfromdatefund = df_getcommonubtdates["fromdatefund"].iloc[0]
    vtodatefund = df_getcommonubtdates["todatefund"].iloc[0]
    vutcfromdatetimebmcs = df_getcommonubtdates["utcfromdatetimebmcs"].iloc[0]
    vutctodatetimebmcs = df_getcommonubtdates["utctodatetimebmcs"].iloc[0]
    vutcfromdatetimeigt = df_getcommonubtdates["utcfromdatetimeigt"].iloc[0]
    vutctodatetimeigt = df_getcommonubtdates["utctodatetimeigt"].iloc[0]
    vutcfromdatetimeob = df_getcommonubtdates["utcfromdatetimeob"].iloc[0]
    vutctodatetimeob = df_getcommonubtdates["utctodatetimeob"].iloc[0]
    vutcfromdatetimenh = df_getcommonubtdates["utcfromdatetimenonhost"].iloc[0]
    vutctodatetimenh = df_getcommonubtdates["utctodatetimenonhost"].iloc[0]
