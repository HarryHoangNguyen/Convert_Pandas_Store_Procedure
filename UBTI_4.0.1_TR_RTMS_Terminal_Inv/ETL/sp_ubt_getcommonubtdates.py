...
def sp_ubt_getcommonubtdates(vfromdate, vtodate):
    ...
    vfromdate = pd.to_datetime(vfromdate)
    vtodate = pd.to_datetime(vtodate)
...
df_dates = sp_ubt_getcommonubtdates('20250625', '20250625')
df_dates.to_csv('debug_common_dates.csv', index=False)