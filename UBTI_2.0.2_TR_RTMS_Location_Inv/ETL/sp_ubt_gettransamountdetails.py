...
def sp_ubt_gettransamountdetails(in_fromdatetime, in_todatetime):
    ...
    vfromdatetimebmcs = df_getcommonubtdates["FROMDATEBMCS"].iloc[0]
    vtodatetimebmcs = df_getcommonubtdates["TODATEBMCS"].iloc[0]
    vfromdatetimeigt = df_getcommonubtdates["FROMDATEIGT"].iloc[0]
    vtodatetimeigt = df_getcommonubtdates["TODATEIGT"].iloc[0]
    vfromdatetimeob = df_getcommonubtdates["FROMDATEOB"].iloc[0]
    vtodatetimeob = df_getcommonubtdates["TODATEOB"].iloc[0]
    vfromdatetimenh = df_getcommonubtdates["FROMDATENONHOST"].iloc[0]
    vtodatetimenh = df_getcommonubtdates["TODATENONHOST"].iloc[0]
    vfromdatefund = df_getcommonubtdates["FUNDFROMDATE"].iloc[0]
    vtodatefund = df_getcommonubtdates["FUNDTODATE"].iloc[0]
    vutcfromdatetimebmcs = df_getcommonubtdates["UTCFROMDATEBMCS"].iloc[0]
    vutctodatetimebmcs = df_getcommonubtdates["UTCTODATEBMCS"].iloc[0]
    vutcfromdatetimeigt = df_getcommonubtdates["UTCFROMDATEIGT"].iloc[0]
    vutctodatetimeigt = df_getcommonubtdates["UTCTODATEIGT"].iloc[0]
    vutcfromdatetimeob = df_getcommonubtdates["UTCFROMDATEOB"].iloc[0]
    vutctodatetimeob = df_getcommonubtdates["UTCTODATEOB"].iloc[0]
    vutcfromdatetimenh = df_getcommonubtdates["UTCFROMDATENONHOST"].iloc[0]
    vutctodatetimenh = df_getcommonubtdates["UTCTODATENONHOST"].iloc[0]
