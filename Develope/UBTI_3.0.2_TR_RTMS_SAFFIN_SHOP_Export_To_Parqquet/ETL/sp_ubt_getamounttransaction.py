...
def sp_ubt_getamounttransaction(infromdate, intodate, logger):
    df_final_result = pd.DataFrame()
    infromdate = pd.to_datetime(infromdate)
    intodate = pd.to_datetime(intodate)
    logger = logger

    df_getcommonubtdates = sp_ubt_getcommonubtdates(infromdate, intodate, logger)
    vfromdatetimebmcs = pd.to_datetime(df_getcommonubtdates["fromdatetimebmcs"].iloc[0])
    vtodatetimebmcs = pd.to_datetime(df_getcommonubtdates["todatetimebmcs"].iloc[0])
    vfromdatetimeigt = pd.to_datetime(df_getcommonubtdates["fromdatetimeigt"].iloc[0])
    vtodatetimeigt = pd.to_datetime(df_getcommonubtdates["todatetimeigt"].iloc[0])
    vfromdatetimeob = pd.to_datetime(df_getcommonubtdates["fromdatetimeob"].iloc[0])
    vtodatetimeob = pd.to_datetime(df_getcommonubtdates["todatetimeob"].iloc[0])
    vfromdatetimenh = pd.to_datetime(df_getcommonubtdates["fromdatetimenonhost"].iloc[0])
    vtodatetimenh = pd.to_datetime(df_getcommonubtdates["todatetimenonhost"].iloc[0])
    vfromdatefund = pd.to_datetime(df_getcommonubtdates["fromdatefund"].iloc[0])
    vtodatefund = pd.to_datetime(df_getcommonubtdates["todatefund"].iloc[0])
    vutcfromdatetimebmcs = pd.to_datetime(df_getcommonubtdates["utcfromdatetimebmcs"].iloc[0])
    vutctodatetimebmcs = pd.to_datetime(df_getcommonubtdates["utctodatetimebmcs"].iloc[0])
    vutcfromdatetimeigt = pd.to_datetime(df_getcommonubtdates["utcfromdatetimeigt"].iloc[0])
    vutctodatetimeigt = pd.to_datetime(df_getcommonubtdates["utctodatetimeigt"].iloc[0])
    vutcfromdatetimeob = pd.to_datetime(df_getcommonubtdates["utcfromdatetimeob"].iloc[0])
    vutctodatetimeob = pd.to_datetime(df_getcommonubtdates["utctodatetimeob"].iloc[0])
    vutcfromdatetimenh = pd.to_datetime(df_getcommonubtdates["utcfromdatetimenonhost"].iloc[0])
    vutctodatetimenh = pd.to_datetime(df_getcommonubtdates["utctodatetimenonhost"].iloc[0])
    # =============================================================================
